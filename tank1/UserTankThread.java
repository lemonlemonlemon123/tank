...
public class UserTankThread implements Runnable, Serializable {
    ...
    private ImageIcon icon=new ImageIcon("src\\tank1\\userBullet.jpg");
    private ImageIcon icon1=new ImageIcon("src\\tank1\\子弹消失.jpg");//子弹消失图片。
    private int direct;
    private int x;
    private int y;
    private boolean isD1=false;
    private boolean isD2=false;
    private boolean isD3=false;
    ...
    public void run() {
        while(aBoolean){
            ...
            boolean isHit3=isDisappear(x,y,o3.getX(),o3.getY());
            if(isHit3){
                isD3=true;
            }
            if((x<-48||y<-38||x>1648||y>838)||isHit1||isHit2||isHit3){
                label.setIcon(icon1);
    ...
    public void setO3(Opponent3 o3) {
        this.o3 = o3;
    }
